...
def create_handler(event, context):
    ...
    for html_file in html_files:
        with open(dir + os.sep + html_file) as f:
            ...
            source_code = source_code.replace("[[NAVBAR]]", textwrap.indent(textwrap.dedent(cg_navbar.create()),"    ") )
            source_code = source_code.replace("[[LOADING MODAL]]", textwrap.indent(textwrap.dedent(cg_loadmod.create()),"    ") )
