                    ...
                    <div class="col">
                        <div class="my-auto">
                            ...
                            <div class="form-group">
                                ...
                                <b-form-input type="text" class="form-control" id="{pk_varname}" placeholder="" v-model="{entity_varname}.{pk_varname}" :state="validation_properties.{pk_varname}.state" {disabled}></b-form-input>
